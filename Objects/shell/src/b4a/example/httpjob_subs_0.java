...
try {
		Debug.PushSubsStack("GetBitmap (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,321);
...
try {
		Debug.PushSubsStack("GetBitmapResize (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,332);
...
try {
		Debug.PushSubsStack("GetBitmapSample (httpjob) ","httpjob",5,__ref.getField(false, "ba"),__ref,328);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","93014668",(RemoteObject.concat(RemoteObject.createImmutable("Invalid link: "),httpjob.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_link))),RemoteObject.createImmutable(""))),0);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","93276808",RemoteObject.createImmutable("Cannot send files from the assets folder."),0);
